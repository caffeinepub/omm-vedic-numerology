...
const tickerText =
  "✨ Tarot Card Reading · 🔢 Numerology · 🏠 Vastu Shastra · 🔤 Pronology · 📍 Bhubaneswar, Odisha · ₹400 per session · Book Now · ";
  ...
  return (
    ...
    >
      <div className="flex animate-marquee whitespace-nowrap">
        ...
        <span
          className="text-cosmic-950 font-semibold text-sm tracking-wide mx-4"
          aria-hidden="true"
        >
          {tickerText}
          {tickerText}
