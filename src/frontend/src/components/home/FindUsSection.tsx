...
export default function FindUsSection() {
  return (
    <section className="py-16 md:py-20 bg-cosmic-deep relative overflow-hidden">
      ...
      <div
        className="absolute top-12 right-16 w-1.5 h-1.5 rounded-full bg-gold/30 animate-twinkle"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute bottom-8 left-1/4 w-1 h-1 rounded-full bg-gold/40 animate-twinkle"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="card-cosmic rounded-2xl p-8 md:p-12 cosmic-glow border border-gold/20 text-center">
          ...
          <div className="bg-gold/8 border border-gold/30 rounded-xl px-6 py-5 mb-6 max-w-2xl mx-auto">
            ...
            <div className="mt-3 pt-3 border-t border-gold/20">
              <p className="font-inter text-xs text-foreground/50 tracking-wide">
                Plus Code:{" "}
                <span className="text-gold/70 font-semibold">6RRQ+93M</span>
              </p>
            </div>
          </div>
          ...
          <p className="font-cormorant text-lg md:text-xl text-foreground/70 italic max-w-2xl mx-auto mb-3 leading-relaxed">
            We are located{" "}
            <strong className="text-gold/90 not-italic font-semibold">
              in front of Jagluck Services Pvt Ltd
            </strong>{" "}
            in Old Town, Bhubaneswar. Use the Plus Code{" "}
            <strong className="text-gold/90 not-italic font-semibold">
              6RRQ+93M
            </strong>{" "}
            on Google Maps for precise navigation.
          </p>
          <p className="font-inter text-sm text-foreground/50 max-w-xl mx-auto mb-8">
            Your reviews and check-ins help others discover authentic Vedic
            guidance. We'd love to see you there!
          </p>
          ...
          <div className="mt-8 flex items-center justify-center gap-2 text-foreground/30">
            ...
            <p className="font-inter text-xs">
              Search{" "}
              <span className="text-gold/50">"Omm Vedic Numerology"</span> on
              Google to find and review our business
            </p>
            <Star className="w-3 h-3 text-gold/40" fill="currentColor" />
          </div>
        </div>
