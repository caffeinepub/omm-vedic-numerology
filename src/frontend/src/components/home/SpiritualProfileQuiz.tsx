    ...
    options: [
      {
        ...
        value: "career",
        points: { numerology: 3, tarot: 1, vastu: 1, pronology: 2 },
      },
      {
        label: "🏠 Home & Family Harmony",
        value: "home",
        points: { numerology: 1, tarot: 0, vastu: 4, pronology: 1 },
      },
      {
        label: "❤️ Love & Relationships",
        value: "love",
        points: { numerology: 2, tarot: 3, vastu: 0, pronology: 2 },
      },
      {
        label: "🌟 Personal Identity & Purpose",
        value: "identity",
        points: { numerology: 2, tarot: 1, vastu: 0, pronology: 4 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "🔢 Numbers and patterns in life",
        value: "numbers",
        points: { numerology: 4, tarot: 0, vastu: 1, pronology: 2 },
      },
      {
        label: "🃏 Symbols and hidden meanings",
        value: "symbols",
        points: { numerology: 0, tarot: 4, vastu: 1, pronology: 1 },
      },
      {
        label: "🏗️ Space, energy, and environment",
        value: "space",
        points: { numerology: 1, tarot: 0, vastu: 4, pronology: 0 },
      },
      {
        label: "🔤 Words, names, and vibrations",
        value: "words",
        points: { numerology: 1, tarot: 1, vastu: 0, pronology: 4 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "🔮 Predictions about my future",
        value: "future",
        points: { numerology: 2, tarot: 4, vastu: 0, pronology: 1 },
      },
      {
        label: "📊 Understanding my life patterns",
        value: "patterns",
        points: { numerology: 4, tarot: 1, vastu: 0, pronology: 2 },
      },
      {
        label: "🌿 Improving my living environment",
        value: "environment",
        points: { numerology: 0, tarot: 0, vastu: 5, pronology: 0 },
      },
      {
        label: "✨ Changing my luck through my name",
        value: "name",
        points: { numerology: 1, tarot: 0, vastu: 0, pronology: 5 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "📅 Through dates and birth numbers",
        value: "dates",
        points: { numerology: 5, tarot: 0, vastu: 0, pronology: 1 },
      },
      {
        label: "🎴 Through visual cards and stories",
        value: "cards",
        points: { numerology: 0, tarot: 5, vastu: 0, pronology: 0 },
      },
      {
        label: "🧭 Through spatial arrangement advice",
        value: "spatial",
        points: { numerology: 0, tarot: 0, vastu: 5, pronology: 0 },
      },
      {
        label: "🔡 Through name analysis and correction",
        value: "nameanalysis",
        points: { numerology: 1, tarot: 0, vastu: 0, pronology: 5 },
      },
    ],
...
const serviceDetails: Record<
  string,
  { name: string; emoji: string; description: string; serviceType: ServiceType }
> = {
  numerology: {
    name: "Numerology",
    emoji: "🔢",
    description:
      "Discover the hidden power of numbers in your life. Your birth date and name hold cosmic codes that reveal your destiny, personality, and life purpose.",
  ...
  tarot: {
    ...
    emoji: "🃏",
    description:
      "Gain profound insights into your past, present, and future through the ancient art of Tarot. Each card reveals hidden truths and guides your path forward.",
  ...
  vastu: {
    ...
    emoji: "🏠",
    description:
      "Transform your living and working spaces using ancient Vedic architecture principles. Align your environment with cosmic energies to attract prosperity and harmony.",
  ...
  pronology: {
    ...
    emoji: "🔤",
    description:
      "Harness the vibrational power of your name. Pronology reveals how the sounds and letters in your name influence your destiny and how small changes can transform your life.",
...
export default function SpiritualProfileQuiz({
  onRecommendService,
}: SpiritualProfileQuizProps) {
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-cosmic-300 mt-3 font-cormorant text-lg">
            Answer 4 questions to discover which service aligns with your cosmic
            journey
          </p>
          ...
          {!completed ? (
            ...
            <div className="p-8 text-center">
              <div className="text-5xl mb-4">
                {serviceDetails[recommended]?.emoji}
              </div>
