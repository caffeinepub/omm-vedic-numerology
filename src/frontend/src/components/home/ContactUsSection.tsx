...
export default function ContactUsSection() {
  return (
    <section className="py-16 md:py-20 bg-cosmic-deep relative overflow-hidden">
      ...
      <div
        className="absolute top-16 right-20 w-1.5 h-1.5 rounded-full bg-gold/30 animate-twinkle"
        style={{ animationDelay: "1.2s" }}
      />
      <div
        className="absolute bottom-10 left-1/3 w-1 h-1 rounded-full bg-gold/40 animate-twinkle"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="card-cosmic rounded-2xl p-8 md:p-12 cosmic-glow border border-gold/20 text-center">
          ...
          <p className="font-cormorant text-lg md:text-xl text-foreground/70 italic max-w-xl mx-auto mb-6 leading-relaxed">
            Have questions about our services? Want to know more before booking?
            Reach out to us directly on WhatsApp — we&apos;re here to guide you.
          </p>
